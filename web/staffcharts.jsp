    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>帖子分类管理 </a>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tr >
                            <td></td>
                            <td><button type="button" class="btn btn-primary" href = "JavaScript:void(0)" onclick="openDialog()">添加帖子</button></td>
                            <td><button type="button" class="btn btn-primary" onclick="return deleteinfo()">删除帖子</button></td>
                        </tr>
                        <tr>
                            <th> </th>
                            <th>ID</th>
                        ...
                        <tbody>
                        <%
                            int count = staffchart.size()/9;
                            int n=0;
                            for(int i=0;i<count;i++) {
                                String ids = "id" + Integer.toString(i);
                        %>
                        <tr>
                            <form id="<%=ids%>" method="post" action="servlet/UpdateOneTieziInfoServlet">
                                ...
                                <td ><input id="iidd" name="sid" readonly="readonly"  value="<%=staffchart.get(n++)%>" style="BACKGROUND-COLOR: transparent;border:0;" size="12"></td>
                                ...
                                <td ><input name="stype" onmouseover="this.select()" value="<%=staffchart.get(n++)%>" style="BACKGROUND-COLOR: transparent;border:0;" size="12"></td>
                                <td ><input name="shenhe" onmouseover="this.select()" value="<%=staffchart.get(n++)%>" style="BACKGROUND-COLOR: transparent;border:0;" size="12"></td>
...
<div id="light" class="white_content">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal" onsubmit="return change3()" action="servlet/adAddOneTieziServlet">
                    ...
                    <div class="line"></div>
                    <div class="form-group row">
                        <label class="col-sm-3 form-control-label">内容</label>
                        <div class="col-sm-9">
                    ...
                    <div class="line"></div>
                    <div class="form-group row">
                        <label class="col-sm-3 form-control-label">地点(学校)</label>
                        <div class="col-sm-9">
                    ...
                    <div class="line"></div>
                    <div class="form-group row">
                        <label class="col-sm-3 form-control-label">类别</label>
                        <div class="col-sm-9">
                            <input name="styple" type="text" class="form-control" >
                        </div>
                    </div>
                    <div>
